...
function navbar(props) {
  return (
    <div className="container-fluid navbar py-2 px-3 fixed-bottom" style={{ maxWidth: '480px' }}>
      <div className="row d-flex justify-content-around">
        ...
        <div className="col-2 text-center px-0">
          <Link to="/login">
            <img src={navbarBeans} className="navbarIcon w-50 py-1" />
            <h6>Biji</h6>
          </Link>
        </div>
        <div className="col-2 text-center px-0">
        ...
        <div className="col-2 text-center px-0">
          <Link to="/activity">
            <img src={navbarActivity} className="navbarIcon w-50 py-1" />
            <h6>Aktivitas</h6>
          </Link>
        </div>
        <div className="col-2 text-center px-0">
          <Link to="/activity">
            <img src={navbarProfile} className="navbarIcon  w-50 py-1" />
            <h6>Profile</h6>
          </Link>
        </div>
      </div>
